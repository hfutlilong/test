...
//import service.impl.ElasticSearchClientFactory;
//
///**
// * @Description TODO
// * @Author lilong
...
// */
//public class TestFilm extends BaseTest {
//    @Autowired
...
//            IndexResponse response = esClientFactory.getClient().prepareIndex("film", "dongzuo")
...
//        SearchRequestBuilder srb = esClientFactory.getClient().prepareSearch("film")
//                .setTypes("dongzuo");
...
//        SearchRequestBuilder srb = esClientFactory.getClient().prepareSearch("film").setTypes("dongzuo");
//        SearchResponse sr = srb.setQuery(QueryBuilders.matchAllQuery())
