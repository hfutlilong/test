...
public class KeyValueJsonPOExample {
    ...
    protected abstract static class GeneratedCriteria {
        protected List<Criterion> valueCriteria;
        ...
        protected GeneratedCriteria() {
            ...
            valueCriteria = new ArrayList<Criterion>();
        }

        public List<Criterion> getValueCriteria() {
            return valueCriteria;
        }

        protected void addValueCriterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            valueCriteria.add(new Criterion(condition, value, "handler.JsonTypeHandler"));
            allCriteria = null;
        }

        protected void addValueCriterion(String condition, KeyValueJsonDTO value1, KeyValueJsonDTO value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            valueCriteria.add(new Criterion(condition, value1, value2, "handler.JsonTypeHandler"));
            allCriteria = null;
        }

        public boolean isValid() {
            return criteria.size() > 0
                || valueCriteria.size() > 0;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(valueCriteria);
            }
            return allCriteria;
        }
        ...
        public Criteria andValueEqualTo(KeyValueJsonDTO value) {
            addValueCriterion("`value` =", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueNotEqualTo(KeyValueJsonDTO value) {
            addValueCriterion("`value` <>", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueGreaterThan(KeyValueJsonDTO value) {
            addValueCriterion("`value` >", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueGreaterThanOrEqualTo(KeyValueJsonDTO value) {
            addValueCriterion("`value` >=", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueLessThan(KeyValueJsonDTO value) {
            addValueCriterion("`value` <", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueLessThanOrEqualTo(KeyValueJsonDTO value) {
            addValueCriterion("`value` <=", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueLike(KeyValueJsonDTO value) {
            addValueCriterion("`value` like", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueNotLike(KeyValueJsonDTO value) {
            addValueCriterion("`value` not like", value, "value");
            return (Criteria) this;
        }

        public Criteria andValueIn(List<KeyValueJsonDTO> values) {
            addValueCriterion("`value` in", values, "value");
            return (Criteria) this;
        }

        public Criteria andValueNotIn(List<KeyValueJsonDTO> values) {
            addValueCriterion("`value` not in", values, "value");
            return (Criteria) this;
        }

        public Criteria andValueBetween(KeyValueJsonDTO value1, KeyValueJsonDTO value2) {
            addValueCriterion("`value` between", value1, value2, "value");
            return (Criteria) this;
        }

        public Criteria andValueNotBetween(KeyValueJsonDTO value1, KeyValueJsonDTO value2) {
            addValueCriterion("`value` not between", value1, value2, "value");
            return (Criteria) this;
        }
